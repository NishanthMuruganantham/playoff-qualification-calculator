...
def homepage():
    ...
    """
        ...
        <hr>
            <p>During the later part of the league stages in many multi-team tournaments 🏆 such as 🏏 Indian Premier League (IPL), Australian Big Bash League (BBL), fans often anxiously await possible match outcomes for the remaining league matches. These outcomes could determine whether their favorite team qualifies for the next stage of the tournament (Playoffs).</p>
    ...
    # Add colorful section for fixture selection
    st.markdown("---")
